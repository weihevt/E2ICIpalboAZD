function data = E2ICIpalboAZD_result(PAR)
%% (29) Function index in the GitHub repository
% This function simulates each parameter set in ./code/mat/opmat.mat and is called by E2ICIpalboAZD_simparcohort().
...
[tICI200nM_palbo50nM_d17,simICI200nM_palbo50nM_d17,~] = E2ICIpalboAZD_sim(x0,tspan,args.treat_ICI200nM_palbo50nM,args);
% E2(10nM)+ICI(200nM)+palbo(100nM)
[tICI200nM_palbo100nM_d17,simICI200nM_palbo100nM_d17,~] = E2ICIpalboAZD_sim(x0,tspan,args.treat_ICI200nM_palbo100nM,args);
% E2(10nM)+ICI(200nM)+palbo(300nM)
[tICI200nM_palbo300nM_d17,simICI200nM_palbo300nM_d17,~] = E2ICIpalboAZD_sim(x0,tspan,args.treat_ICI200nM_palbo300nM,args);
%% protein data
% week 1d
teval_days = 7;
