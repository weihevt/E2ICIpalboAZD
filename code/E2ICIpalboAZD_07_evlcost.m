function cost = E2ICIpalboAZD_07_evlcost(parop,args,ind,i_group,opt)
% This function is for parameter estimation during optimization. It calls
% the function E2ICIpalboAZD_08_cost().

if opt
   args.PAR(ind) = parop;
end

ind = E2ICIpalboAZD_09_onesteadystate(args);
if ind
...
tspan = [0,24 * 30];
[~,~,xinitial,mse_use] = E2ICIpalboAZD_29_sim(x0,tspan,args.treat_non,args);
if ~isnan(mse_use)
    cost = args.mse_error;return;
end
...
x0(args.ind_reset) = 0;
x0 = E2ICIpalboAZD_21_replating(x0,args);
[tE2,simE2,~,mse_use] = E2ICIpalboAZD_29_sim(x0,tspan,args.treat_non,args);
if ~isnan(mse_use);cost = args.mse_error;return;end
%% (2)E2(10nM)+ICI(500nM)
[tICI500nM,simICI500nM,~,mse_use] = E2ICIpalboAZD_29_sim(x0,tspan,args.treat_ICI500nM,args);
if ~isnan(mse_use);cost = args.mse_error;return;end
%% (3)E2(10nM)+palbo(250nM)
[tpalbo250nM,simpalbo250nM,~,mse_use] = E2ICIpalboAZD_29_sim(x0,tspan,args.treat_palbo250nM,args);
if ~isnan(mse_use);cost = args.mse_error;return;end
%% (4)E2(10nM)+palbo(500nM)
[tpalbo500nM,simpalbo500nM,~,mse_use] = E2ICIpalboAZD_29_sim(x0,tspan,args.treat_palbo500nM,args);
if ~isnan(mse_use);cost = args.mse_error;return;end
%% (4)E2(10nM)+palbo(1uM)
[tpalbo1uM,simpalbo1uM,~,mse_use] = E2ICIpalboAZD_29_sim(x0,tspan,args.treat_palbo1uM,args);
if ~isnan(mse_use);cost = args.mse_error;return;end
...
[tpalbo750nM_13m,...
 simpalbo750nM_13m,...
 xpalbo750nM_13m,...
 mse_use] = E2ICIpalboAZD_31_simalternation(x0,tspan,treatalter,cycletime,replate,args);
if ~isnan(mse_use);cost = args.mse_error;return;end
...
% E2(10nM)+ICI(200nM)
x0(args.E2mediaindex) = xinitial(args.E2mediaindex);
[tICI200nM_d17,simICI200nM_d17,~,mse_use] = E2ICIpalboAZD_29_sim(x0,tspan,args.treat_ICI200nM,args);
if ~isnan(mse_use);cost = args.mse_error;return;end
pos = find(tICI200nM_d17 == tspan(end), 1, 'last');
cellnum_ICI200nM_d17 = simICI200nM_d17(end,pos);

% E2(10nM)+ICI(200nM)+palbo(50nM)
[tICI200nM_palbo50nM_d17,simICI200nM_palbo50nM_d17,~,mse_use] = E2ICIpalboAZD_29_sim(x0,tspan,args.treat_ICI200nM_palbo50nM,args);
if ~isnan(mse_use);cost = args.mse_error;return;end
...
[tICI200nM_palbo100nM_d17,simICI200nM_palbo100nM_d17,~,mse_use] = E2ICIpalboAZD_29_sim(x0,tspan,args.treat_ICI200nM_palbo100nM,args);
if ~isnan(mse_use);cost = args.mse_error;return;end
...
[tICI200nM_palbo300nM_d17,simICI200nM_palbo300nM_d17,~,mse_use] = E2ICIpalboAZD_29_sim(x0,tspan,args.treat_ICI200nM_palbo300nM,args);
if ~isnan(mse_use);cost = args.mse_error;return;end
pos = find(tICI200nM_palbo300nM_d17 == tspan(end), 1, 'last');
cellnum_ICI200nM_palbo300nM_d17 = simICI200nM_palbo300nM_d17(end,pos);
%% Cost
cost = E2ICIpalboAZD_08_cost(args,...                                     (1)
                             tE2,...                                      (2)
                             tICI500nM,...                                (3)
                             tpalbo250nM,...                              (4)
                             tpalbo500nM,...                              (5)
                             ...
                             tICI750nM_13m,...                            (8)
                             tAZD250nM_13m,...                            (9)
                             tICI750nMAZD250nM_13m,...                    (10)
                             tAlter_palbo750nM_ICI750nM_13m,...           (11)
                             tAlter_palbo750nM_ICI750nMAZD250nM_13m,...   (12)
                             simE2,...                                    (13)
                             simICI500nM,...                              (14)
                             simpalbo250nM,...                            (15)
                             simpalbo500nM,...                            (16)
                             simpalbo1uM,...                              (17)
                             simpalbo750nM_13m,...                        (18)
                             simICI750nM_13m,...                          (19)
                             simAZD250nM_13m,...                          (20)
                             simICI750nMAZD250nM_13m,...                  (21)   
                             simAlter_palbo750nM_ICI750nM_13m,...         (22)
                             simAlter_palbo750nM_ICI750nMAZD250nM_13m,... (23)
                             xpalbo750nM_13m,...                          (24)
                             xICI750nM_13m,...                            (25)
                             xAlter_palbo750nM_ICI750nM,...               (26)
                             xAlter_palbo750nM_ICI750nMAZD250nM_13m,...   (27)
                             cellnum_ICI200nM_d17,...                     (28)
                             cellnum_ICI200nM_palbo50nM_d17,...           (29)
                             cellnum_ICI200nM_palbo100nM_d17,...          (30)
                             cellnum_ICI200nM_palbo300nM_d17 ...          (31)
                             );            
