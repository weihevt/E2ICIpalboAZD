...
% This is the core function that generates the parameter cohort; it is called by E2ICIpalboAZD_parcohort().
% input:
...
%                          'EliteCount',EliteCount,...
%                          'CrossoverFraction',0,...
%                          'OutputFcns',@(x,y,z)E2depICIpalbo_mygaoutput(x,y,z,costthreshold));
