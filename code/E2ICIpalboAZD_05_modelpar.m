function args = E2ICIpalboAZD_05_modelpar()
% This function generates the necessary given parameters for the model
% simulation and lists the variables defined in the model.

pathload = './mat/';
[~,lb,ub,grouppar,groupparall,power_ind] = E2ICIpalboAZD_04_par();
