function [tout,simout,xout,mse_use] = E2ICIpalboAZD_31_simalternation(x0,tspan,treatalter,cycletime,replate,args)
...
while tin < max(tspan)
    ...
    [t,~,x,mse_use] = E2ICIpalboAZD_29_sim(x0,tspan_i,treat_i,args);
    if ~isnan(mse_use)
