function E2ICIpalboAZD_26_plot()
...
print(gcf,[pathsave,'FigS2.pdf'],'-dpdf','-bestfit')
close gcf
%% Proliferation
close all
...
print(gcf,[pathsave,'FigS1A.pdf'],'-dpdf','-bestfit')
close gcf
% (2)E2(10nM)+ICI(500nM), FigS1B
ylimval = [-.1,40];
xtickdata = {'0','1','3','6','7','14','21','28'};
timepro = [0,1,3,6,7,14,21,28];
titlename = 'E2+ICI(500nM), FigS1B';
figure;hold on
h = child_plotpro(timepro,...
...
set(gcf,'position',position)
print(gcf,[pathsave,'FigS1B.pdf'],'-dpdf','-bestfit')
close gcf
% (3)E2(10nM)+palbo(500nM), Fig S1C
ylimval = [-.1,40];
titlename = 'E2+palbo(500nM), FigS1C';
figure;hold on
h = child_plotpro(timepro,...
...
legend([h{2},h{1}.mainLine],{'Experiment','Calibrated simulation'},'box','off','location','NW')
set(gcf,'position',position)
print(gcf,[pathsave,'FigS1C.pdf'],'-dpdf','-bestfit')
close gcf
% (4)E2(10nM)+palbo(1uM), Fig S1D
titlename = 'E2+palbo(1uM), FigS1D';
figure;hold on
h = child_plotpro(timepro,...
...
legend([h{2},h{1}.mainLine],{'Experiment','Calibrated simulation'},'box','off','location','NW')
set(gcf,'position',position)
print(gcf,[pathsave,'FigS1D.pdf'],'-dpdf','-bestfit')
close gcf
