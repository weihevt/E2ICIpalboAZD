function E2ICIpalboAZD_01_main()
% This function runs the simulation and produces plots using the optimized parameter set.

% These plots represent the primary simulation results and are directly compared with the experimental data.
...
replate = true;
[tpalbo750nM_13m,simpalbo750nM_13m,xpalbo750nM_13m] = E2ICIpalboAZD_31_simalternation(x0,tspan,treatalter,cycletime,replate,args);
...
[tICI200nM_palbo50nM_d17,simICI200nM_palbo50nM_d17,~] =...
    E2ICIpalboAZD_29_sim(x0,tspan,args.treat_ICI200nM_palbo50nM,args);
% E2(10nM)+ICI(200nM)+palbo(100nM)
[tICI200nM_palbo100nM_d17,simICI200nM_palbo100nM_d17,~] =...
    E2ICIpalboAZD_29_sim(x0,tspan,args.treat_ICI200nM_palbo100nM,args);
% E2(10nM)+ICI(200nM)+palbo(300nM)
[tICI200nM_palbo300nM_d17,simICI200nM_palbo300nM_d17,~] =...
    E2ICIpalboAZD_29_sim(x0,tspan,args.treat_ICI200nM_palbo300nM,args);
%% protein data
% week 1d
teval = 7;
...
ylimval = [0,3];
E2ICIpalboAZD_16_barplot(CyclinE1_mean,CyclinE1_sem,CyclinE1_label,title_str,ylabel_str,ylimval,positionval)
...
E2ICIpalboAZD_28_plotpro(timepoint,expmean,expstd,tE2(1:pos),simE2(end,1:pos),...
...
legendloc = 'NW';
ylimval = [-1,80];
E2ICIpalboAZD_28_plotpro(args.timepoint_pro([1,end]),...
...
ylimval = [-1,30];
color = ['g','g'];
E2ICIpalboAZD_27_plotalterpro(data.Long12month.time(1:2),...
