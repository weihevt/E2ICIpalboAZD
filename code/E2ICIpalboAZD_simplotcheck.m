...
ylimval = [0,3];
E2ICIpalboAZD_barplot(CyclinE1_mean,CyclinE1_sem,CyclinE1_time,title_str,ylabel_str,ylimval,positionval)
xlabel('Time(days)')
...
E2ICIpalboAZD_plotpro(timepoint,expmean,expstd,tE2,simE2(end,:),...
